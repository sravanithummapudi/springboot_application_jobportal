...
import com.example.jobportal.demo.jobportal.entity.IRecruiterJobs;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    //retrieves list of jobs for given recruiter id combines job post activity,job location,job company
    // also includes a count of job seekers who have applied for a given job
